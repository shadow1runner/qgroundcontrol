...
public:
    void loadSettings() {
        ...
        _writeToOutputEnabled            = settings.value("WriteToOutputEnabled", true).toBool(),
        ...
        _inlierProportionThresholdEnabled= settings.value("InlierProportionThresholdEnabled", true).toBool();
    ...
    void storeSettings() {
        ...
        settings.setValue("WriteToOutputEnabled", _writeToOutputEnabled);
        ...
        settings.setValue("InlierProportionThresholdEnabled", _inlierProportionThresholdEnabled);
...
public:
    ...
    bool              getWriteToOutputEnabled() const             { return _writeToOutputEnabled;      }
    ...
    bool              getInlierProportionThresholdEnabled() const { return _inlierProportionThresholdEnabled; }
    ...
    void setWriteToOutputEnabled(bool writeToOutputEnabled)          { _writeToOutputEnabled  = writeToOutputEnabled;      }
    ...
    void setInlierProportionThresholdEnabled(bool inlierProportionThresholdEnabled) { _inlierProportionThresholdEnabled = inlierProportionThresholdEnabled; }
...
private:
    ...
    QString _fileName;
    int     _device;
    bool    _writeToOutputEnabled;
    QString _outputDir;
    int     _subsampleAmount;
    int     _particles;
    int     _windowSize;
    bool    _inlierProportionThresholdEnabled;
